...
if(isset($_POST['email'])) {
   ...
   // $email_to = "companysharptech@gmail.com";
    $email_subject = "Request Quote from Swadhey Membership Login Form";
  ...
  $aadhar_exp = '/^(\d{12}|\d{16})$/';
 
  if(!preg_match($aadhar_exp,$addharno)) {
    $error_message .= 'The Addhar no. you entered does not appear to be valid.<br />';
  }
  ...
  if(strlen($error_message) > 0) {
   ...
   // $email_message = "Form details below.\n\n";
	...
	$email_message .= "<tr><td colspan='2' style='background: #4c57a6; color:#fff;text-align:center;'><strong>Swadhey Membership Details</strong> </td></tr>";
  ...
  $email_message .= "<tr><td style='background: #f1f1f1;'><strong>Aadhar No.:</strong> </td><td style='background: #f1f1f1;'>" .clean_string($addharno). "</td></tr>";
  ...
  $email_message .= "<tr><td style='background: #f1f1f1;'><strong>About Member:</strong> </td><td style='background: #f1f1f1;'>" .clean_string($yourself). "</td></tr>";
	$email_message .= "</table>";
